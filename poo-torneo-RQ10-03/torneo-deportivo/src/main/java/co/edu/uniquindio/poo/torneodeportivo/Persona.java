...
public class Persona {
    ...
    public Persona(String nombre,String apellido,String email, String celular, String genero) {
        ...
        ASSERTION.assertion( genero != null && !genero.isBlank() , "El email es requerido");
