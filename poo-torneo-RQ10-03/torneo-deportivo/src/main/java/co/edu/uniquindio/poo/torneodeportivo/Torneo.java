...
public class Torneo {
     ...
     * @throws RuntimeException, Se genera un error si ya existe un equipo
     *                           registrado con el mismo nombre, o en caso de que
     *                           las inscripciones del torneo no estén abiertas.
     */
    ...
    public void registrarJugador(String nombre, Jugador jugador) {
        jugador.getGenero().equalsIgnoreCase(getGenero());
