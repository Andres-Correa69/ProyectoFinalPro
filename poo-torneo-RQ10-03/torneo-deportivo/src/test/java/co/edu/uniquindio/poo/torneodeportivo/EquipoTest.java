...
public class EquipoTest {
    ...
    public void inscripcionCerrada() {
        ...
        Torneo torneo = new Torneo("Copa Mundo","genero", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().minusDays(1), (byte)24, (byte)0, 0,TipoTorneo.LOCAL,CaracterTorneo.GRUPAL);
    ...
    public void inscripcionNoAbierta() {
        ...
        Torneo torneo = new Torneo("Copa Mundo", "genero", LocalDate.now().plusMonths(1), LocalDate.now().plusDays(1), LocalDate.now().plusDays(15), (byte)24, (byte)0, 0,TipoTorneo.LOCAL,CaracterTorneo.GRUPAL);
