...
public class TorneoModificarFechasTest {
    ...
    public void modificarFechaInicio() {
        ...
        Torneo torneo = new Torneo("Copa Mundo", "genero", LocalDate.of(2023, 10, 1), LocalDate.of(2023, 8, 1), LocalDate.of(2023, 9, 15), (byte)24, (byte)0, 0,TipoTorneo.LOCAL,CaracterTorneo.GRUPAL);
